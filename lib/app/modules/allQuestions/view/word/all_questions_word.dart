...
class AllQuestionsWord extends GetView<AllQuestionWordController> {
  const AllQuestionsWord({Key? key}) : super(key: key);
  static const String routesname = '/allquestionsword';
  @override
    ...
    return Scaffold(
      ...
      appBar: AllCustomAppBar(
        leading: InkWell(
          onTap: () {
            controller.reset();
            controller.questionsList.value = <AllQuestions>[];
          },
          child: Icon(
                            ...
                            child: SingleChildScrollView(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  GetBuilder<AllQuestionWordController>(
                                    id: 'answers_list',
                                    builder: (context) {
