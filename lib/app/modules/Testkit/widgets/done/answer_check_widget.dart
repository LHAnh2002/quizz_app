...
class AnswerCheckWidget extends GetView<TestKillQuestionController> {
  const AnswerCheckWidget({Key? key}) : super(key: key);
  static const String routeName = '/answercheckwidgets';
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBarWidget(
        ...
        showActionIcon: true,
        onMenuActionTap: () {
          Get.toNamed(ResultWidget.rountName);
        },
      ),
                      ...
                      SingleChildScrollView(
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            SizedBox(width: 0.0, height: 10.h),
                            GetBuilder<TestKillQuestionController>(
                                ...
                                return ListView.separated(
                                  ...
                                  itemBuilder: (_, index) {
                                    ...
                                    if (correctAnswer == selectedAnswer &&
                                      ...
                                      return CorrectWidgetTestKill(
                                        answer: answersText,
                                        identifier: identifierText,
                                      );
                                    } else if (selectedAnswer == null) {
                                      return NotAnswerWidgetTestKill(
                                        answer: answersText,
                                        identifier: identifierText,
                                      );
                                  ...
                                  separatorBuilder: (_, index) {
                                    return SizedBox(width: 0.0, height: 10.h);
                                  },
