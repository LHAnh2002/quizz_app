...
class TestKillAnswerCheckScreen extends GetView<TestKillQuestionController> {
  const TestKillAnswerCheckScreen({Key? key}) : super(key: key);
  static const String routeName = '/testkillanswercheck';
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: TestKillCustomAppBar(
        ...
        showActionIcon: true,
        onMenuActionTap: () {
          Get.toNamed(TestKillResultScreen.rountName);
        },
      ),
