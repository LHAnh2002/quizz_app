...
enum AnswerStatusWord { correct, wrong, answered, nottanswered }

class AnswerWidgetWord extends StatelessWidget {
  final String answer;
  final String identifier;
  final bool isSelected;
  final VoidCallback onTap;
  const AnswerWidgetWord(
      {Key? key,
...
class CorrectWidgetWord extends StatelessWidget {
  const CorrectWidgetWord(
...
class WrongWidgetWord extends StatelessWidget {
  const WrongWidgetWord(
      {Key? key, required this.answer, required this.identifier})
      : super(key: key);
  final String answer;
  final String identifier;
...
class NotAnswerWidgetWord extends GetView<AllQuestionWordController> {
  const NotAnswerWidgetWord(
      {Key? key, required this.answer, required this.identifier})
      : super(key: key);
  final String answer;
  final String identifier;
