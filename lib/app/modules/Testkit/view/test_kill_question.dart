...
class TestKillQuestion extends GetView<TestKillQuestionController> {
  const TestKillQuestion({Key? key}) : super(key: key);
  static const String routesname = '/testKillQuestion';
  @override
