...
import 'package:quizz_app/app/modules/wrongSentence/widgets/custom_appBar_wrong.dart';

class WrongSentenceView extends GetView<WrongController> {
  const WrongSentenceView({Key? key}) : super(key: key);
  static const String routesname = '/questionswrong';
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      extendBodyBehindAppBar: true,
      appBar: CustomAppBarWrong(
        leading: InkWell(
          onTap: () {
            controller.reset();
        ...
        titleWidget: Text(
          Strings.wrong,
          style:
              AppTextStyle.semiBoldMediumStyle.copyWith(color: AppColors.white),
        ),
      ),
